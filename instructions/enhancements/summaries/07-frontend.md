...
- **Commit:** `stage 07: implement browser edition UI`
...
- `browser-edition/app.js` — UI screen coordination, public snapshot rendering,
  Worker intents, transient virus feedback, and local error/pending states.
...
All five stable threat IDs have direct local visual mappings. Virus highlights
use only the returned `virus_signature.targets` feedback and expire after the
documented animation duration.
